...
def parse_args():
    ...
    parser.add_argument('bit_depth', help='raw data bit depth')
...
def save_image(raw_data, raw_data_file, raw_data_folder):
    visual_folder = os.path.join('output', 'visual_capture', raw_data_folder)
    if not os.path.exists(visual_folder):
        os.makedirs(visual_folder)
    visual_file = os.path.join(visual_folder, raw_data_file)
...
if __name__ == '__main__':
    main()
#python tools/visual_capture.py /root/caixin/data/imagenet_caps_384_12bit_Feb_19/n01440764/n01440764_457.png 12